	...
	do{
		...
		switch (res){
			case 1:
				...
				do{
					system("cls");
					cout<<"_______________-1.Operaciones Basicas con 2 numeros-_______________"<<endl;
			...
			case 2:
				...
				do{
					system("cls");
					cout<<"_______________-2. Determinar si un nmero es par o impar-_______________"<<endl;
					cout<<"Ingrese el primer numero"<<endl;
					cin>>num1;
					respuesta = num1%2;
			...
			case 3:
				...
				do{
					system("cls");
					cout<<"_______________-3. Conversiones de medidas-_______________"<<endl;
			...
			case 4:
				...
				do{
					system("cls");
					cout<<"_______________-4. Palabras Palindromas-_______________"<<endl;
					string input;
			...
			case 5:
				...
				do{
					system("cls");
					cout<<"_______________-5. Numeros Arabigos a Romanos-_______________"<<endl;
			...
			break;
				...
				do{
					system("cls");
					cout<<"_______________-6. Convertir Numeros a Letras-_______________"<<endl;
					string input;
			...
			case 7:
				...
				do{
					system("cls");
					cout<<"_______________-7. Una Tabla de multiplicar-_______________"<<endl;
			...
			case 8:
				...
				do{
					system("cls");
					cout<<"_______________-8. Todas las tablas de multiplicar-_______________"<<endl;
			...
			case 9:
				...
				do{
					system("cls");
					cout<<"_______________-9. Decimales a binarios-_______________"<<endl;
			...
			case 10:
				...
				do{
					system("cls");
					cout<<"_______________-10. Decimal a Hexadecimal-_______________"<<endl;
			...
			case 11:
				...
				do{
					system("cls");
					cout<<"_______________-11. Figuras Geometricas-_______________"<<endl;
			...
			case 12:
				...
				do{
					system("cls");
					cout<<"_______________-12. Calcular hipotenusa-_______________"<<endl;
